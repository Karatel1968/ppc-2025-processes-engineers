...
class UrinOGaussVertDiagSEQ : public BaseTask {
 ...
 private:
  ...
  static void GenerateRandomMatrix(size_t size, std::vector<std::vector<double>> &matrix, 
                                   std::vector<double> &vector);
  bool SolveGaussian(const std::vector<std::vector<double>> &a, const std::vector<double> &b,
                     std::vector<double> &x);
};
